  ...
  return [
    {
      ...
      annotations: getToolAnnotations("create-role", "Create Role"),
      inputSchema: {
        type: "object",
        properties: {
          name: {
    ...
    },
    {
      ...
      annotations: getToolAnnotations("update-role", "Update Role"),
      inputSchema: {
        type: "object",
        properties: {
          roleId: {
    ...
    },
    {
      ...
      annotations: getToolAnnotations("delete-role", "Delete Role"),
      inputSchema: {
        type: "object",
        properties: {
          roleId: {
    ...
    },
    {
      ...
      annotations: getToolAnnotations("get-roles", "List All Roles"),
      inputSchema: {
        type: "object",
        properties: {
          limit: {
    ...
    },
    {
      ...
      annotations: getToolAnnotations("get-role", "Get Role Details"),
      inputSchema: {
        type: "object",
        properties: {
          roleId: {
...
async function handleCreateRole(
  ...
  try {
    ...
    if (errorMessage.includes("already exists")) {
      ...
      displayMessage =
        "One or more permissions are invalid. Use get-permissions to see available permissions.";
    }
