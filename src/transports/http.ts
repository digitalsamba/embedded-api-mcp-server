          ...
          <div class="accordion-item">
            <button class="accordion-header" aria-expanded="false" onclick="toggleAccordion(this)">
              ...
              <div class="platform-info">
                <h3>Claude Code</h3>
                <p>Terminal-based AI coding assistant</p>
              </div>
            ...
            <div class="accordion-content">
              <p class="setup-step">Run this command in your terminal:</p>
              <div class="setup-code">
                <code>claude mcp add --transport http digitalsamba https://mcp.digitalsamba.com/mcp</code>
                <button class="copy-code" onclick="copyCode(this)">Copy</button>
              </div>
              <p class="setup-step">Then use the <strong>/mcp</strong> command in Claude Code to authenticate.</p>
            </div>
          </div>
          <div class="accordion-item">
            <button class="accordion-header" aria-expanded="false" onclick="toggleAccordion(this)">
              ...
              <div class="platform-info">
                ...
                <p>Desktop app with MCP support</p>
              </div>
              <svg class="accordion-chevron" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg>
            </button>
            <div class="accordion-content">
              <p class="setup-step">Add to your <strong>claude_desktop_config.json</strong>:</p>
              <div class="setup-code">
                <code>{
  "mcpServers": {
    "digitalsamba": {
      "url": "https://mcp.digitalsamba.com/mcp"
              ...
              <p class="setup-step">Restart Claude Desktop and authenticate when prompted.</p>
            </div>
          </div>
          <div class="accordion-item">
            <button class="accordion-header" aria-expanded="false" onclick="toggleAccordion(this)">
            ...
            <div class="accordion-content">
              <p class="setup-step">Use the server URL with any MCP-compatible client:</p>
              <div class="setup-code">
                <code>https://mcp.digitalsamba.com/mcp</code>
                <button class="copy-code" onclick="copyCode(this)">Copy</button>
              </div>
              <p class="setup-step">The server supports <strong>Streamable HTTP</strong> transport with <strong>OAuth 2.0</strong> authentication.</p>
            </div>
          </div>
        </div>
      </div>
